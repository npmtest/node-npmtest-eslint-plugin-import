...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/ExportMap.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/ExportMap.js</span></h1>
    <h2>
        
        Statements: <span class="metric">13.86% <small>(37 / 267)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">5.07% <small>(7 / 138)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">8.33% <small>(2 / 24)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">15.45% <small>(34 / 220)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/</a> &#187; ExportMap.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >    this.namespace = new Map();</span>
    // todo: restructure to key on path, value is resolver + map of names
<span class="cstat-no" title="statement not covered" >    this.reexports = new Map();</span>
<span class="cstat-no" title="statement not covered" >    this.dependencies = new Map();</span>
...
<span class="cstat-no" title="statement not covered" >    return this.get('default') != null;</span>
  } // stronger than this.has
&nbsp;
  get size<span class="fstat-no" title="function not covered" >() {</span>
<span class="cstat-no" title="statement not covered" >    let size = this.namespace.size + this.reexports.size;</span>
<span class="cstat-no" title="statement not covered" >    this.dependencies.forEach(dep =&gt; <span class="cstat-no" title="statement not covered" >size += dep().size)</span>;</span>
...
<span class="cstat-no" title="statement not covered" >    if (this.namespace.has(name)) <span class="cstat-no" title="statement not covered" >return true;</span></span>
<span class="cstat-no" title="statement not covered" >    if (this.reexports.has(name)) <span class="cstat-no" title="statement not covered" >return true;</span></span>
&nbsp;
    // default exports must be explicitly re-exported (#328)
<span class="cstat-no" title="statement not covered" >    if (name !== 'default') {</span>
<span class="cstat-no" title="statement not covered" >      for (let dep of this.dependencies.values()) {</span>
<span class="cstat-no" title="statement not covered" >        let innerMap = dep();</span>
&nbsp;
        // todo: report as unresolved?
<span class="cstat-no" title="statement not covered" >        if (!innerMap) <span class="cstat-no" title="statement not covered" >continue;</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (innerMap.has(name)) <span class="cstat-no" title="statement not covered" >return true;</span></span>
      }
    }
&nbsp;
...
&nbsp;
   ...
   */
  hasDeep<span class="fstat-no" title="function not covered" >(name) {</span>
<span class="cstat-no" title="statement not covered" >    if (this.namespace.has(name)) <span class="cstat-no" title="statement not covered" >return { found: true, path: [this] };</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (this.reexports.has(name)) {</span>
<span class="cstat-no" title="statement not covered" >      const reexports = this.reexports.get(name),</span>
            imported = reexports.getImport();
&nbsp;
      // if import is ignored, return explicit 'null'
<span class="cstat-no" title="statement not covered" >      if (imported == null) <span class="cstat-no" title="statement not covered" >return { found: true, path: [this] };</span></span>
&nbsp;
      // safeguard against cycles, only if name matches
<span class="cstat-no" title="statement not covered" >      if (imported.path === this.path &amp;&amp; reexports.local === name) {</span>
<span class="cstat-no" title="statement not covered" >        return { found: false, path: [this] };</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      const deep = imported.hasDeep(reexports.local);</span>
<span class="cstat-no" title="statement not covered" >      deep.path.unshift(this);</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        if (innerMap.path === this.path) <span class="cstat-no" title="statement not covered" >continue;</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        let innerValue = innerMap.hasDeep(name);</span>
<span class="cstat-no" title="statement not covered" >        if (innerValue.found) {</span>
<span class="cstat-no" title="statement not covered" >          innerValue.path.unshift(this);</span>
<span class="cstat-no" title="statement not covered" >          return innerValue;</span>
        }
      }
    }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    if (this.namespace.has(name)) <span class="cstat-no" title="statement not covered" >return this.namespace.get(name);</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (this.reexports.has(name)) {</span>
<span class="cstat-no" title="statement not covered" >      const reexports = this.reexports.get(name),</span>
            imported = reexports.getImport();
&nbsp;
      // if import is ignored, return explicit 'null'
<span class="cstat-no" title="statement not covered" >      if (imported == null) <span class="cstat-no" title="statement not covered" >return null;</span></span>
&nbsp;
      // safeguard against cycles, only if name matches
<span class="cstat-no" title="statement not covered" >      if (imported.path === this.path &amp;&amp; reexports.local === name) <span class="cstat-no" title="statement not covered" >return undefined;</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      return imported.get(reexports.local);</span>
    }
&nbsp;
    // default exports must be explicitly re-exported (#328)
<span class="cstat-no" title="statement not covered" >    if (name !== 'default') {</span>
...
<span class="cstat-no" title="statement not covered" >        if (innerMap.path === this.path) <span class="cstat-no" title="statement not covered" >continue;</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        let innerValue = innerMap.get(name);</span>
<span class="cstat-no" title="statement not covered" >        if (innerValue !== undefined) <span class="cstat-no" title="statement not covered" >return innerValue;</span></span>
      }
    }
&nbsp;
...
&nbsp;
  forEach<span class="fstat-no" title="function not covered" >(callback, thisArg) {</span>
<span class="cstat-no" title="statement not covered" >    this.namespace.forEach((v, n) =&gt; <span class="cstat-no" title="statement not covered" >callback.call(thisArg, v, n, this))</span>;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.reexports.forEach((reexports, name) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      const reexported = reexports.getImport();</span>
      // can't look up meta for ignored re-exports (#348)
<span class="cstat-no" title="statement not covered" >      callback.call(thisArg, reexported &amp;&amp; reexported.get(reexports.local), name, this);</span>
    });
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.dependencies.forEach(dep =&gt; <span class="cstat-no" title="statement not covered" >dep().forEach((v, n) =&gt; <span class="cstat-no" title="statement not covered" >n !== 'default' &amp;&amp; callback.call(thisArg, v, n, this))</span>)</span>;</span>
  }
&nbsp;
  // todo: keys, values, entries?
&nbsp;
  reportErrors<span class="fstat-no" title="function not covered" >(context, declaration) {</span>
<span class="cstat-no" title="statement not covered" >    context.report({</span>
      node: declaration.source,
      message: `Parse errors in imported module '${ declaration.source.value }': ` + `${ this.errors.map(e =&gt; <span class="cstat-no" title="statement not covered" >`${ e.message } (${ e.lineNumber }:${ e.column })`)</span>.join(', ') }`
    });
  }
}
&nbsp;
exports.default = ExportMap; /**
                              ...
                              */
&nbsp;
<span class="fstat-no" title="function not covered" >function captureDoc(docStyleParsers) {</span>
<span class="cstat-no" title="statement not covered" >  const metadata = {},</span>
        nodes = Array.prototype.slice.call(arguments, 1);
&nbsp;
  // 'some' short-circuits on first 'true'
<span class="cstat-no" title="statement not covered" >  nodes.some(n =&gt; {</span>
<span class="cstat-no" title="statement not covered" >    if (!n.leadingComments) <span class="cstat-no" title="statement not covered" >return false;</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    for (let name in docStyleParsers) {</span>
<span class="cstat-no" title="statement not covered" >      const doc = docStyleParsers[name](n.leadingComments);</span>
<span class="cstat-no" title="statement not covered" >      if (doc) {</span>
<span class="cstat-no" title="statement not covered" >        metadata.doc = doc;</span>
      }
    }
&nbsp;
 ...
 * @return {{doc: object}}
 */
<span class="fstat-no" title="function not covered" >function captureJsDoc(comments) {</span>
...
<span class="cstat-no" title="statement not covered" >    if (comment.value.slice(0, 4) !== '*\n *') <span class="cstat-no" title="statement not covered" >return;</span></span>
<span class="cstat-no" title="statement not covered" >    try {</span>
<span class="cstat-no" title="statement not covered" >      doc = _doctrine2.default.parse(comment.value, { unwrap: true });</span>
    } catch (err) {
...
/**
  ...
  */
<span class="fstat-no" title="function not covered" >function captureTomDoc(comments) {</span>
...
<span class="cstat-no" title="statement not covered" >    if (comment.value.match(/^\s*$/)) <span class="cstat-no" title="statement not covered" >break;</span></span>
<span class="cstat-no" title="statement not covered" >    lines.push(comment.value.trim());</span>
  }
&nbsp;
  // return doctrine-like object
<span class="cstat-no" title="statement not covered" >  const statusMatch = lines.join(' ').match(/^(Public|Internal|Deprecated):\s*(.+)/);</span>
<span class="cstat-no" title="statement not covered" >  if (statusMatch) {</span>
...
&nbsp;
ExportMap.get = <span class="fstat-no" title="function not covered" >function (source, context) {</span>
<span class="cstat-no" title="statement not covered" >  const path = (0, _resolve2.default)(source, context);</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  return ExportMap.for(path, context);</span>
};
&nbsp;
ExportMap.for = <span class="fstat-no" title="function not covered" >function (path, context) {</span>
<span class="cstat-no" title="statement not covered" >  let exportMap;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  const cacheKey = (0, _hash.hashObject)({</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  exportMap = exportCache.get(cacheKey);</span>
&nbsp;
  // return cached ignore
<span class="cstat-no" title="statement not covered" >  if (exportMap === null) <span class="cstat-no" title="statement not covered" >return null;</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  const stats = _fs2.default.statSync(path);</span>
<span class="cstat-no" title="statement not covered" >  if (exportMap != null) {</span>
    // date equality check
<span class="cstat-no" title="statement not covered" >    if (exportMap.mtime - stats.mtime === 0) {</span>
<span class="cstat-no" title="statement not covered" >      return exportMap;</span>
    }
    // future: check content equality?
  }
&nbsp;
  // check valid extensions first
<span class="cstat-no" title="statement not covered" >  if (!(0, _ignore.hasValidExtension)(path, context)) {</span>
<span class="cstat-no" title="statement not covered" >    exportCache.set(cacheKey, null);</span>
<span class="cstat-no" title="statement not covered" >    return null;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  const content = _fs2.default.readFileSync(path, { encoding: 'utf8' });</span>
&nbsp;
  // check for and cache ignore
<span class="cstat-no" title="statement not covered" >  if ((0, _ignore2.default)(path, context) || !unambiguous.test(content)) {</span>
<span class="cstat-no" title="statement not covered" >    log('ignored path due to unambiguous regex or ignore settings:', path);</span>
<span class="cstat-no" title="statement not covered" >    exportCache.set(cacheKey, null);</span>
<span class="cstat-no" title="statement not covered" >    return null;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  exportMap = ExportMap.parse(path, content, context);</span>
&nbsp;
  // ambiguous modules return null
<span class="cstat-no" title="statement not covered" >  if (exportMap == null) <span class="cstat-no" title="statement not covered" >return null;</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  exportMap.mtime = stats.mtime;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  exportCache.set(cacheKey, exportMap);</span>
<span class="cstat-no" title="statement not covered" >  return exportMap;</span>
};
&nbsp;
ExportMap.parse = <span class="fstat-no" title="function not covered" >function (path, content, context) {</span>
<span class="cstat-no" title="statement not covered" >  var m = new ExportMap(path);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  try {</span>
<span class="cstat-no" title="statement not covered" >    var ast = (0, _parse2.default)(path, content, context);</span>
  } catch (err) {
<span class="cstat-no" title="statement not covered" >    log('parse error:', path, err);</span>
<span class="cstat-no" title="statement not covered" >    m.errors.push(err);</span>
<span class="cstat-no" title="statement not covered" >    return m; </span>// can't continue
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!unambiguous.isModule(ast)) <span class="cstat-no" title="statement not covered" >return null;</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  const docstyle = context.settings &amp;&amp; context.settings['import/docstyle'] || ['jsdoc'];</span>
<span class="cstat-no" title="statement not covered" >  const docStyleParsers = {};</span>
<span class="cstat-no" title="statement not covered" >  docstyle.forEach(style =&gt; {</span>
<span class="cstat-no" title="statement not covered" >    docStyleParsers[style] = availableDocStyleParsers[style];</span>
  });
&nbsp;
  // attempt to collect module doc
<span class="cstat-no" title="statement not covered" >  ast.comments.some(c =&gt; {</span>
<span class="cstat-no" title="statement not covered" >    if (c.type !== 'Block') <span class="cstat-no" title="statement not covered" >return false;</span></span>
<span class="cstat-no" title="statement not covered" >    try {</span>
<span class="cstat-no" title="statement not covered" >      const doc = _doctrine2.default.parse(c.value, { unwrap: true });</span>
<span class="cstat-no" title="statement not covered" >      if (doc.tags.some(t =&gt; <span class="cstat-no" title="statement not covered" >t.title === 'module')</span>) {</span>
<span class="cstat-no" title="statement not covered" >        m.doc = doc;</span>
<span class="cstat-no" title="statement not covered" >        return true;</span>
      }
    } catch (err) {/* ignore */}
<span class="cstat-no" title="statement not covered" >    return false;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  const namespaces = new Map();</span>
&nbsp;
<span class="fstat-no" title="function not covered" >  function remotePath(node) {</span>
<span class="cstat-no" title="statement not covered" >    return _resolve2.default.relative(node.source.value, path, context.settings);</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  function resolveImport(node) {</span>
<span class="cstat-no" title="statement not covered" >    const rp = remotePath(node);</span>
<span class="cstat-no" title="statement not covered" >    if (rp == null) <span class="cstat-no" title="statement not covered" >return null;</span></span>
<span class="cstat-no" title="statement not covered" >    return ExportMap.for(rp, context);</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  function getNamespace(identifier) {</span>
<span class="cstat-no" title="statement not covered" >    if (!namespaces.has(identifier.name)) <span class="cstat-no" title="statement not covered" >return;</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >      return resolveImport(namespaces.get(identifier.name));</span>
    };
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  function addNamespace(object, identifier) {</span>
<span class="cstat-no" title="statement not covered" >    const nsfn = getNamespace(identifier);</span>
<span class="cstat-no" title="statement not covered" >    if (nsfn) {</span>
<span class="cstat-no" title="statement not covered" >      Object.defineProperty(object, 'namespace', { get: nsfn });</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return object;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  ast.body.forEach(<span class="fstat-no" title="function not covered" >function (n) {</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (n.type === 'ExportDefaultDeclaration') {</span>
<span class="cstat-no" title="statement not covered" >      const exportMeta = captureDoc(docStyleParsers, n);</span>
<span class="cstat-no" title="statement not covered" >      if (n.declaration.type === 'Identifier') {</span>
<span class="cstat-no" title="statement not covered" >        addNamespace(exportMeta, n.declaration);</span>
      }
<span class="cstat-no" title="statement not covered" >      m.namespace.set('default', exportMeta);</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (n.type === 'ExportAllDeclaration') {</span>
<span class="cstat-no" title="statement not covered" >      let remoteMap = remotePath(n);</span>
<span class="cstat-no" title="statement not covered" >      if (remoteMap == null) <span class="cstat-no" title="statement not covered" >return;</span></span>
<span class="cstat-no" title="statement not covered" >      m.dependencies.set(remoteMap, () =&gt; <span class="cstat-no" title="statement not covered" >ExportMap.for(remoteMap, context))</span>;</span>
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
    // capture namespaces in case of later export
<span class="cstat-no" title="statement not covered" >    if (n.type === 'ImportDeclaration') {</span>
<span class="cstat-no" title="statement not covered" >      let ns;</span>
<span class="cstat-no" title="statement not covered" >      if (n.specifiers.some(s =&gt; <span class="cstat-no" title="statement not covered" >s.type === 'ImportNamespaceSpecifier' &amp;&amp; (ns = s))</span>) {</span>
<span class="cstat-no" title="statement not covered" >        namespaces.set(ns.local.name, n);</span>
      }
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (n.type === 'ExportNamedDeclaration') {</span>
      // capture declaration
<span class="cstat-no" title="statement not covered" >      if (n.declaration != null) {</span>
<span class="cstat-no" title="statement not covered" >        switch (n.declaration.type) {</span>
          case 'FunctionDeclaration':
          case 'ClassDeclaration':
          case 'TypeAlias':
            // flowtype with babel-eslint parser
<span class="cstat-no" title="statement not covered" >            m.namespace.set(n.declaration.id.name, captureDoc(docStyleParsers, n));</span>
<span class="cstat-no" title="statement not covered" >            break;</span>
          case 'VariableDeclaration':
<span class="cstat-no" title="statement not covered" >            n.declaration.declarations.forEach(d =&gt; <span class="cstat-no" title="statement not covered" >recursivePatternCapture(d.id, id =&gt; <span class="cstat-no" title="statement not covered" >m.namespace.set(id.name, captureDoc(docStyleParsers, d, n)))</span>)</span>;</span>
<span class="cstat-no" title="statement not covered" >            break;</span>
        }
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      n.specifiers.forEach(s =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        const exportMeta = {};</span>
<span class="cstat-no" title="statement not covered" >        let local;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        switch (s.type) {</span>
          case 'ExportDefaultSpecifier':
<span class="cstat-no" title="statement not covered" >            if (!n.source) <span class="cstat-no" title="statement not covered" >return;</span></span>
<span class="cstat-no" title="statement not covered" >            local = 'default';</span>
<span class="cstat-no" title="statement not covered" >            break;</span>
          case 'ExportNamespaceSpecifier':
<span class="cstat-no" title="statement not covered" >            m.namespace.set(s.exported.name, Object.defineProperty(exportMeta, 'namespace', {</span>
              get<span class="fstat-no" title="function not covered" >() {</span>
<span class="cstat-no" title="statement not covered" >                return resolveImport(n);</span>
              }
            }));
<span class="cstat-no" title="statement not covered" >            return;</span>
          case 'ExportSpecifier':
<span class="cstat-no" title="statement not covered" >            if (!n.source) {</span>
<span class="cstat-no" title="statement not covered" >              m.namespace.set(s.exported.name, addNamespace(exportMeta, s.local));</span>
<span class="cstat-no" title="statement not covered" >              return;</span>
            }
          // else falls through
          default:
<span class="cstat-no" title="statement not covered" >            local = s.local.name;</span>
<span class="cstat-no" title="statement not covered" >            break;</span>
        }
&nbsp;
        // todo: JSDoc
<span class="cstat-no" title="statement not covered" >        m.reexports.set(s.exported.name, { local, getImport: () =&gt; <span class="cstat-no" title="statement not covered" >resolveImport(n) </span>});</span>
      });
    }
  });
&nbsp;
 ...
 * @return {void}
 */
<span class="fstat-no" title="function not covered" >function recursivePatternCapture(pattern, callback) {</span>
<span class="cstat-no" title="statement not covered" >  switch (pattern.type) {</span>
    case 'Identifier':
      // base case
...
&nbsp;
    case 'ObjectPattern':
<span class="cstat-no" title="statement not covered" >      pattern.properties.forEach(p =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        recursivePatternCapture(p.value, callback);</span>
      });
<span class="cstat-no" title="statement not covered" >      break;</span>
&nbsp;
    case 'ArrayPattern':
<span class="cstat-no" title="statement not covered" >      pattern.elements.forEach(element =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        if (element == null) <span class="cstat-no" title="statement not covered" >return;</span></span>
<span class="cstat-no" title="statement not covered" >        recursivePatternCapture(element, callback);</span>
      });
<span class="cstat-no" title="statement not covered" >      break;</span>
  }
}
...
<div class="footer">
    <div class="meta">Generated by <a href="https://github.com/kaizhu256/node-utility2" target="_blank">utility2</a> at Tue Apr 25 2017 18:05:02 GMT+0000 (UTC)</div>
</div>
</body>
</html>
