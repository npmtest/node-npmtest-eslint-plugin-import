...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/namespace.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/namespace.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/</a> &#187; namespace.js</div>
</div>
<div class="body">
...
&nbsp;
  create: <span class="fstat-no" title="function not covered" >function namespaceRule(context) {</span>
&nbsp;
    // read options
<span class="cstat-no" title="statement not covered" >    var _ref = context.options[0] || {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var _ref$allowComputed = _ref.allowComputed;</span>
<span class="cstat-no" title="statement not covered" >    const allowComputed = _ref$allowComputed === undefined ? false : _ref$allowComputed;</span>
&nbsp;
&nbsp;
<span class="cstat-no" title="statement not covered" >    const namespaces = new Map();</span>
&nbsp;
<span class="fstat-no" title="function not covered" >    function makeMessage(last, namepath) {</span>
<span class="cstat-no" title="statement not covered" >      return `'${ last.name }' not found in` + (namepath.length &gt; 1 ? ' deeply ' : ' ') + `imported namespace '${ namepath.join('.') }'.`;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return {</span>
&nbsp;
      // pick up all imports at body entry time, to properly respect hoisting
      'Program': <span class="fstat-no" title="function not covered" >function (_ref2) {</span>
<span class="cstat-no" title="statement not covered" >        let body = _ref2.body;</span>
&nbsp;
<span class="fstat-no" title="function not covered" >        function processBodyStatement(declaration) {</span>
<span class="cstat-no" title="statement not covered" >          if (declaration.type !== 'ImportDeclaration') <span class="cstat-no" title="statement not covered" >return;</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (declaration.specifiers.length === 0) <span class="cstat-no" title="statement not covered" >return;</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          const imports = _ExportMap2.default.get(declaration.source.value, context);</span>
<span class="cstat-no" title="statement not covered" >          if (imports == null) <span class="cstat-no" title="statement not covered" >return null;</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (imports.errors.length) {</span>
<span class="cstat-no" title="statement not covered" >            imports.reportErrors(context, declaration);</span>
<span class="cstat-no" title="statement not covered" >            return;</span>
          }
&nbsp;
<span class="cstat-no" title="statement not covered" >          for (let specifier of declaration.specifiers) {</span>
<span class="cstat-no" title="statement not covered" >            switch (specifier.type) {</span>
              case 'ImportNamespaceSpecifier':
<span class="cstat-no" title="statement not covered" >                if (!imports.size) {</span>
<span class="cstat-no" title="statement not covered" >                  context.report(specifier, `No exported names found in module '${ declaration.source.value }'.`);</span>
                }
<span class="cstat-no" title="statement not covered" >                namespaces.set(specifier.local.name, imports);</span>
<span class="cstat-no" title="statement not covered" >                break;</span>
              case 'ImportDefaultSpecifier':
              case 'ImportSpecifier':
                {
<span class="cstat-no" title="statement not covered" >                  const meta = imports.get(</span>
                  // default to 'default' for default http://i.imgur.com/nj6qAWy.jpg
                  specifier.imported ? specifier.imported.name : 'default');
<span class="cstat-no" title="statement not covered" >                  if (!meta || !meta.namespace) <span class="cstat-no" title="statement not covered" >break;</span></span>
<span class="cstat-no" title="statement not covered" >                  namespaces.set(specifier.local.name, meta.namespace);</span>
<span class="cstat-no" title="statement not covered" >                  break;</span>
                }
            }
          }
        }
<span class="cstat-no" title="statement not covered" >        body.forEach(processBodyStatement);</span>
      },
&nbsp;
      // same as above, but does not add names to local map
      'ExportNamespaceSpecifier': <span class="fstat-no" title="function not covered" >function (namespace) {</span>
<span class="cstat-no" title="statement not covered" >        var declaration = (0, _importDeclaration2.default)(context);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        var imports = _ExportMap2.default.get(declaration.source.value, context);</span>
<span class="cstat-no" title="statement not covered" >        if (imports == null) <span class="cstat-no" title="statement not covered" >return null;</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (imports.errors.length) {</span>
<span class="cstat-no" title="statement not covered" >          imports.reportErrors(context, declaration);</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!imports.size) {</span>
<span class="cstat-no" title="statement not covered" >          context.report(namespace, `No exported names found in module '${ declaration.source.value }'.`);</span>
        }
      },
&nbsp;
      // todo: check for possible redefinition
&nbsp;
      'MemberExpression': <span class="fstat-no" title="function not covered" >function (dereference) {</span>
<span class="cstat-no" title="statement not covered" >        if (dereference.object.type !== 'Identifier') <span class="cstat-no" title="statement not covered" >return;</span></span>
<span class="cstat-no" title="statement not covered" >        if (!namespaces.has(dereference.object.name)) <span class="cstat-no" title="statement not covered" >return;</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (dereference.parent.type === 'AssignmentExpression' &amp;&amp; dereference.parent.left === dereference) {</span>
<span class="cstat-no" title="statement not covered" >          context.report(dereference.parent, `Assignment to member of namespace '${ dereference.object.name }'.`);</span>
        }
&nbsp;
        // go deep
<span class="cstat-no" title="statement not covered" >        var namespace = namespaces.get(dereference.object.name);</span>
<span class="cstat-no" title="statement not covered" >        var namepath = [dereference.object.name];</span>
        // while property is namespace and parent is member expression, keep validating
<span class="cstat-no" title="statement not covered" >        while (namespace instanceof _ExportMap2.default &amp;&amp; dereference.type === 'MemberExpression') {</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (dereference.computed) {</span>
<span class="cstat-no" title="statement not covered" >            if (!allowComputed) {</span>
<span class="cstat-no" title="statement not covered" >              context.report(dereference.property, 'Unable to validate computed reference to imported namespace \'' + dereference.object.name + '\'.');</span>
            }
<span class="cstat-no" title="statement not covered" >            return;</span>
          }
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (!namespace.has(dereference.property.name)) {</span>
<span class="cstat-no" title="statement not covered" >            context.report(dereference.property, makeMessage(dereference.property, namepath));</span>
<span class="cstat-no" title="statement not covered" >            break;</span>
          }
&nbsp;
<span class="cstat-no" title="statement not covered" >          const exported = namespace.get(dereference.property.name);</span>
<span class="cstat-no" title="statement not covered" >          if (exported == null) <span class="cstat-no" title="statement not covered" >return;</span></span>
&nbsp;
          // stash and pop
<span class="cstat-no" title="statement not covered" >          namepath.push(dereference.property.name);</span>
<span class="cstat-no" title="statement not covered" >          namespace = exported.namespace;</span>
<span class="cstat-no" title="statement not covered" >          dereference = dereference.parent;</span>
        }
      },
&nbsp;
      'VariableDeclarator': <span class="fstat-no" title="function not covered" >function (_ref3) {</span>
<span class="cstat-no" title="statement not covered" >        let id = _ref3.id;</span>
<span class="cstat-no" title="statement not covered" >        let init = _ref3.init;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (init == null) <span class="cstat-no" title="statement not covered" >return;</span></span>
<span class="cstat-no" title="statement not covered" >        if (init.type !== 'Identifier') <span class="cstat-no" title="statement not covered" >return;</span></span>
<span class="cstat-no" title="statement not covered" >        if (!namespaces.has(init.name)) <span class="cstat-no" title="statement not covered" >return;</span></span>
&nbsp;
        // check for redefinition in intermediate scopes
<span class="cstat-no" title="statement not covered" >        if ((0, _declaredScope2.default)(context, init.name) !== 'module') <span class="cstat-no" title="statement not covered" >return;</span></span>
&nbsp;
        // DFS traverse child namespaces
<span class="fstat-no" title="function not covered" >        function testKey(pattern, namespace) {</span>
<span class="cstat-no" title="statement not covered" >          let path = arguments.length &gt; 2 &amp;&amp; arguments[2] !== undefined ? arguments[2] : [init.name];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (!(namespace instanceof _ExportMap2.default)) <span class="cstat-no" title="statement not covered" >return;</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (pattern.type !== 'ObjectPattern') <span class="cstat-no" title="statement not covered" >return;</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          for (let property of pattern.properties) {</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (property.key.type !== 'Identifier') {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (!namespace.has(property.key.name)) {</span>
<span class="cstat-no" title="statement not covered" >              context.report({</span>
                node: property,
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            path.push(property.key.name);</span>
<span class="cstat-no" title="statement not covered" >            testKey(property.value, namespace.get(property.key.name).namespace, path);</span>
<span class="cstat-no" title="statement not covered" >            path.pop();</span>
          }
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        testKey(id, namespaces.get(init.name));</span>
      }
    };
  }
};
