...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/no-webpack-loader-syntax.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/no-webpack-loader-syntax.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/</a> &#187; no-webpack-loader-syntax.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >function reportIfNonStandard(context, node, name) {</span>
<span class="cstat-no" title="statement not covered" >  if (name.indexOf('!') !== -1) {</span>
<span class="cstat-no" title="statement not covered" >    context.report(node, `Unexpected '!' in '${ name }'. ` + 'Do not use import syntax to configure webpack loaders.');</span>
  }
}
&nbsp;
module.exports = {
...
<span class="cstat-no" title="statement not covered" >        reportIfNonStandard(context, node, node.source.value);</span>
      },
...
<span class="cstat-no" title="statement not covered" >          reportIfNonStandard(context, node, node.arguments[0].value);</span>
        }
      }
    };
  }
