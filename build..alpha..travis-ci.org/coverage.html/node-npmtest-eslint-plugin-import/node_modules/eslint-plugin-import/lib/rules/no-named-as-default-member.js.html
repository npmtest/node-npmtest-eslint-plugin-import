...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/no-named-as-default-member.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/no-named-as-default-member.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/</a> &#187; no-named-as-default-member.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    const fileImports = new Map();</span>
<span class="cstat-no" title="statement not covered" >    const allPropertyLookups = new Map();</span>
&nbsp;
<span class="fstat-no" title="function not covered" >    function handleImportDefault(node) {</span>
<span class="cstat-no" title="statement not covered" >      const declaration = (0, _importDeclaration2.default)(context);</span>
<span class="cstat-no" title="statement not covered" >      const exportMap = _ExportMap2.default.get(declaration.source.value, context);</span>
<span class="cstat-no" title="statement not covered" >      if (exportMap == null) <span class="cstat-no" title="statement not covered" >return;</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (exportMap.errors.length) {</span>
<span class="cstat-no" title="statement not covered" >        exportMap.reportErrors(context, declaration);</span>
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      fileImports.set(node.local.name, {</span>
        exportMap,
        sourcePath: declaration.source.value
      });
    }
&nbsp;
<span class="fstat-no" title="function not covered" >    function storePropertyLookup(objectName, propName, node) {</span>
<span class="cstat-no" title="statement not covered" >      const lookups = allPropertyLookups.get(objectName) || [];</span>
<span class="cstat-no" title="statement not covered" >      lookups.push({ node, propName });</span>
<span class="cstat-no" title="statement not covered" >      allPropertyLookups.set(objectName, lookups);</span>
    }
&nbsp;
<span class="fstat-no" title="function not covered" >    function handlePropLookup(node) {</span>
<span class="cstat-no" title="statement not covered" >      const objectName = node.object.name;</span>
<span class="cstat-no" title="statement not covered" >      const propName = node.property.name;</span>
<span class="cstat-no" title="statement not covered" >      storePropertyLookup(objectName, propName, node);</span>
    }
&nbsp;
<span class="fstat-no" title="function not covered" >    function handleDestructuringAssignment(node) {</span>
<span class="cstat-no" title="statement not covered" >      const isDestructure = node.id.type === 'ObjectPattern' &amp;&amp; node.init != null &amp;&amp; node.init.type === 'Identifier';</span>
<span class="cstat-no" title="statement not covered" >      if (!isDestructure) <span class="cstat-no" title="statement not covered" >return;</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      const objectName = node.init.name;</span>
<span class="cstat-no" title="statement not covered" >      for (const _ref of node.id.properties) {</span>
<span class="cstat-no" title="statement not covered" >        const key = _ref.key;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (key == null) <span class="cstat-no" title="statement not covered" >continue; </span></span>// true for rest properties
<span class="cstat-no" title="statement not covered" >        storePropertyLookup(objectName, key.name, key);</span>
      }
    }
&nbsp;
<span class="fstat-no" title="function not covered" >    function handleProgramExit() {</span>
<span class="cstat-no" title="statement not covered" >      allPropertyLookups.forEach((lookups, objectName) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        const fileImport = fileImports.get(objectName);</span>
<span class="cstat-no" title="statement not covered" >        if (fileImport == null) <span class="cstat-no" title="statement not covered" >return;</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        for (const _ref2 of lookups) {</span>
<span class="cstat-no" title="statement not covered" >          const propName = _ref2.propName;</span>
<span class="cstat-no" title="statement not covered" >          const node = _ref2.node;</span>
&nbsp;
          // the default import can have a "default" property
<span class="cstat-no" title="statement not covered" >          if (propName === 'default') <span class="cstat-no" title="statement not covered" >continue;</span></span>
<span class="cstat-no" title="statement not covered" >          if (!fileImport.exportMap.namespace.has(propName)) <span class="cstat-no" title="statement not covered" >continue;</span></span>
&nbsp;
