...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/no-commonjs.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/no-commonjs.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/</a> &#187; no-commonjs.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >function allowPrimitive(node, context) {</span>
<span class="cstat-no" title="statement not covered" >  if (context.options.indexOf('allow-primitive-modules') &lt; 0) <span class="cstat-no" title="statement not covered" >return false;</span></span>
<span class="cstat-no" title="statement not covered" >  if (node.parent.type !== 'AssignmentExpression') <span class="cstat-no" title="statement not covered" >return false;</span></span>
<span class="cstat-no" title="statement not covered" >  return node.parent.right.type !== 'ObjectExpression';</span>
}
&nbsp;
//------------------------------------------------------------------------------
// Rule Definition
...
&nbsp;
        // module.exports
<span class="cstat-no" title="statement not covered" >        if (node.object.name === 'module' &amp;&amp; node.property.name === 'exports') {</span>
<span class="cstat-no" title="statement not covered" >          if (allowPrimitive(node, context)) <span class="cstat-no" title="statement not covered" >return;</span></span>
<span class="cstat-no" title="statement not covered" >          context.report({ node, message: EXPORT_MESSAGE });</span>
        }
&nbsp;
        // exports.
<span class="cstat-no" title="statement not covered" >        if (node.object.name === 'exports') {</span>
<span class="cstat-no" title="statement not covered" >          context.report({ node, message: EXPORT_MESSAGE });</span>
        }
      },
      'CallExpression': <span class="fstat-no" title="function not covered" >function (call) {</span>
<span class="cstat-no" title="statement not covered" >        if (context.getScope().type !== 'module') <span class="cstat-no" title="statement not covered" >return;</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (call.callee.type !== 'Identifier') <span class="cstat-no" title="statement not covered" >return;</span></span>
<span class="cstat-no" title="statement not covered" >        if (call.callee.name !== 'require') <span class="cstat-no" title="statement not covered" >return;</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (call.arguments.length !== 1) <span class="cstat-no" title="statement not covered" >return;</span></span>
<span class="cstat-no" title="statement not covered" >        var module = call.arguments[0];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (module.type !== 'Literal') <span class="cstat-no" title="statement not covered" >return;</span></span>
<span class="cstat-no" title="statement not covered" >        if (typeof module.value !== 'string') <span class="cstat-no" title="statement not covered" >return;</span></span>
&nbsp;
