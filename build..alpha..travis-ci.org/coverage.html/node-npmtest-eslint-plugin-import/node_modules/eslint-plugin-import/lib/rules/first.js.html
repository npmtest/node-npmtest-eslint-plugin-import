...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/first.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/first.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/</a> &#187; first.js</div>
</div>
<div class="body">
...
<span class="fstat-no" title="function not covered" >    function isPossibleDirective(node) {</span>
<span class="cstat-no" title="statement not covered" >      return node.type === 'ExpressionStatement' &amp;&amp; node.expression.type === 'Literal' &amp;&amp; typeof node.expression.value === 'string';</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return {</span>
      'Program': <span class="fstat-no" title="function not covered" >function (n) {</span>
<span class="cstat-no" title="statement not covered" >        const body = n.body,</span>
              absoluteFirst = context.options[0] === 'absolute-first';
<span class="cstat-no" title="statement not covered" >        let nonImportCount = 0,</span>
...
<span class="cstat-no" title="statement not covered" >          if (!anyExpressions &amp;&amp; isPossibleDirective(node)) {</span>
<span class="cstat-no" title="statement not covered" >            return;</span>
          }
&nbsp;
<span class="cstat-no" title="statement not covered" >          anyExpressions = true;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (node.type === 'ImportDeclaration') {</span>
<span class="cstat-no" title="statement not covered" >            if (absoluteFirst) {</span>
<span class="cstat-no" title="statement not covered" >              if (/^\./.test(node.source.value)) {</span>
<span class="cstat-no" title="statement not covered" >                anyRelative = true;</span>
              } else <span class="cstat-no" title="statement not covered" >if (anyRelative) {</span>
...
<span class="cstat-no" title="statement not covered" >            if (nonImportCount &gt; 0) {</span>
<span class="cstat-no" title="statement not covered" >              context.report({</span>
                node,
...
<span class="cstat-no" title="statement not covered" >            nonImportCount++;</span>
          }
        });
      }
    };
