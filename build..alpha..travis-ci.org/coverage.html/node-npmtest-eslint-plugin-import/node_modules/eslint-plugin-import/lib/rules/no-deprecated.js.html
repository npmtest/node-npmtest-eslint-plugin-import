...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/no-deprecated.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/no-deprecated.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/</a> &#187; no-deprecated.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >function message(deprecation) {</span>
<span class="cstat-no" title="statement not covered" >  return 'Deprecated' + (deprecation.description ? ': ' + deprecation.description : '.');</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function getDeprecation(metadata) {</span>
<span class="cstat-no" title="statement not covered" >  if (!metadata || !metadata.doc) <span class="cstat-no" title="statement not covered" >return;</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  let deprecation;</span>
<span class="cstat-no" title="statement not covered" >  if (metadata.doc.tags.some(t =&gt; <span class="cstat-no" title="statement not covered" >t.title === 'deprecated' &amp;&amp; (deprecation = t))</span>) {</span>
<span class="cstat-no" title="statement not covered" >    return deprecation;</span>
  }
}
&nbsp;
module.exports = {
...
<span class="cstat-no" title="statement not covered" >    const deprecated = new Map(),</span>
          namespaces = new Map();
&nbsp;
<span class="fstat-no" title="function not covered" >    function checkSpecifiers(node) {</span>
<span class="cstat-no" title="statement not covered" >      if (node.type !== 'ImportDeclaration') <span class="cstat-no" title="statement not covered" >return;</span></span>
<span class="cstat-no" title="statement not covered" >      if (node.source == null) <span class="cstat-no" title="statement not covered" >return; </span></span>// local export, ignore
&nbsp;
<span class="cstat-no" title="statement not covered" >      const imports = _ExportMap2.default.get(node.source.value, context);</span>
<span class="cstat-no" title="statement not covered" >      if (imports == null) <span class="cstat-no" title="statement not covered" >return;</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      let moduleDeprecation;</span>
<span class="cstat-no" title="statement not covered" >      if (imports.doc &amp;&amp; imports.doc.tags.some(t =&gt; <span class="cstat-no" title="statement not covered" >t.title === 'deprecated' &amp;&amp; (moduleDeprecation = t))</span>) {</span>
<span class="cstat-no" title="statement not covered" >        context.report({ node, message: message(moduleDeprecation) });</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (imports.errors.length) {</span>
<span class="cstat-no" title="statement not covered" >        imports.reportErrors(context, node);</span>
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      node.specifiers.forEach(<span class="fstat-no" title="function not covered" >function (im) {</span></span>
<span class="cstat-no" title="statement not covered" >        let imported, local;</span>
<span class="cstat-no" title="statement not covered" >        switch (im.type) {</span>
&nbsp;
          case 'ImportNamespaceSpecifier':
            {
<span class="cstat-no" title="statement not covered" >              if (!imports.size) <span class="cstat-no" title="statement not covered" >return;</span></span>
<span class="cstat-no" title="statement not covered" >              namespaces.set(im.local.name, imports);</span>
<span class="cstat-no" title="statement not covered" >              return;</span>
            }
&nbsp;
          case 'ImportDefaultSpecifier':
<span class="cstat-no" title="statement not covered" >            imported = 'default';</span>
<span class="cstat-no" title="statement not covered" >            local = im.local.name;</span>
<span class="cstat-no" title="statement not covered" >            break;</span>
&nbsp;
          case 'ImportSpecifier':
<span class="cstat-no" title="statement not covered" >            imported = im.imported.name;</span>
<span class="cstat-no" title="statement not covered" >            local = im.local.name;</span>
<span class="cstat-no" title="statement not covered" >            break;</span>
&nbsp;
          default:
<span class="cstat-no" title="statement not covered" >            return; </span>// can't handle this one
        }
&nbsp;
        // unknown thing can't be deprecated
<span class="cstat-no" title="statement not covered" >        const exported = imports.get(imported);</span>
...
<span class="cstat-no" title="statement not covered" >        if (exported.namespace) <span class="cstat-no" title="statement not covered" >namespaces.set(local, exported.namespace);</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        const deprecation = getDeprecation(imports.get(imported));</span>
<span class="cstat-no" title="statement not covered" >        if (!deprecation) <span class="cstat-no" title="statement not covered" >return;</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        context.report({ node: im, message: message(deprecation) });</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        deprecated.set(local, deprecation);</span>
      });
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return {</span>
      'Program': (_ref) =&gt; {
<span class="cstat-no" title="statement not covered" >        let body = _ref.body;</span>
<span class="cstat-no" title="statement not covered" >        return body.forEach(checkSpecifiers);</span>
      },
&nbsp;
      'Identifier': <span class="fstat-no" title="function not covered" >function (node) {</span>
<span class="cstat-no" title="statement not covered" >        if (node.parent.type === 'MemberExpression' &amp;&amp; node.parent.property === node) {</span>
<span class="cstat-no" title="statement not covered" >          return; </span>// handled by MemberExpression
        }
&nbsp;
        // ignore specifier identifiers
<span class="cstat-no" title="statement not covered" >        if (node.parent.type.slice(0, 6) === 'Import') <span class="cstat-no" title="statement not covered" >return;</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!deprecated.has(node.name)) <span class="cstat-no" title="statement not covered" >return;</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if ((0, _declaredScope2.default)(context, node.name) !== 'module') <span class="cstat-no" title="statement not covered" >return;</span></span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        if ((0, _declaredScope2.default)(context, dereference.object.name) !== 'module') <span class="cstat-no" title="statement not covered" >return;</span></span>
&nbsp;
        // go deep
...
<span class="cstat-no" title="statement not covered" >          if (dereference.computed) <span class="cstat-no" title="statement not covered" >return;</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          const metadata = namespace.get(dereference.property.name);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (!metadata) <span class="cstat-no" title="statement not covered" >break;</span></span>
<span class="cstat-no" title="statement not covered" >          const deprecation = getDeprecation(metadata);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (deprecation) {</span>
<span class="cstat-no" title="statement not covered" >            context.report({ node: dereference.property, message: message(deprecation) });</span>
          }
&nbsp;
          // stash and pop
<span class="cstat-no" title="statement not covered" >          namepath.push(dereference.property.name);</span>
<span class="cstat-no" title="statement not covered" >          namespace = metadata.namespace;</span>
