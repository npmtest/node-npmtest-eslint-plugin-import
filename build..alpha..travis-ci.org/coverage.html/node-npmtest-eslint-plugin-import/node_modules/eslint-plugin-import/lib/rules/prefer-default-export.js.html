...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/prefer-default-export.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/prefer-default-export.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/</a> &#187; prefer-default-export.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >    let specifierExportCount = 0;</span>
<span class="cstat-no" title="statement not covered" >    let hasDefaultExport = false;</span>
<span class="cstat-no" title="statement not covered" >    let hasStarExport = false;</span>
<span class="cstat-no" title="statement not covered" >    let namedExportNode = null;</span>
&nbsp;
<span class="fstat-no" title="function not covered" >    function captureDeclaration(identifierOrPattern) {</span>
<span class="cstat-no" title="statement not covered" >      if (identifierOrPattern.type === 'ObjectPattern') {</span>
        // recursively capture
<span class="cstat-no" title="statement not covered" >        identifierOrPattern.properties.forEach(<span class="fstat-no" title="function not covered" >function (property) {</span></span>
<span class="cstat-no" title="statement not covered" >          captureDeclaration(property.value);</span>
        });
      } else {
        // assume it's a single standard identifier
<span class="cstat-no" title="statement not covered" >        specifierExportCount++;</span>
      }
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return {</span>
      'ExportDefaultSpecifier': <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >        hasDefaultExport = true;</span>
      },
&nbsp;
      'ExportSpecifier': <span class="fstat-no" title="function not covered" >function (node) {</span>
<span class="cstat-no" title="statement not covered" >        if (node.exported.name === 'default') {</span>
<span class="cstat-no" title="statement not covered" >          hasDefaultExport = true;</span>
        } else {
<span class="cstat-no" title="statement not covered" >          specifierExportCount++;</span>
<span class="cstat-no" title="statement not covered" >          namedExportNode = node;</span>
        }
      },
&nbsp;
      'ExportNamedDeclaration': <span class="fstat-no" title="function not covered" >function (node) {</span>
        // if there are specifiers, node.declaration should be null
<span class="cstat-no" title="statement not covered" >        if (!node.declaration) <span class="cstat-no" title="statement not covered" >return;</span></span>
&nbsp;
        // don't count flow types exports
<span class="cstat-no" title="statement not covered" >        if (node.exportKind === 'type') <span class="cstat-no" title="statement not covered" >return;</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (node.declaration.declarations) {</span>
<span class="cstat-no" title="statement not covered" >          node.declaration.declarations.forEach(<span class="fstat-no" title="function not covered" >function (declaration) {</span></span>
<span class="cstat-no" title="statement not covered" >            captureDeclaration(declaration.id);</span>
          });
        } else {
...
&nbsp;
      'ExportDefaultDeclaration': <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >        hasDefaultExport = true;</span>
      },
&nbsp;
      'ExportAllDeclaration': <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >        hasStarExport = true;</span>
      },
&nbsp;
      'Program:exit': <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >        if (specifierExportCount === 1 &amp;&amp; !hasDefaultExport &amp;&amp; !hasStarExport) {</span>
<span class="cstat-no" title="statement not covered" >          context.report(namedExportNode, 'Prefer default export.');</span>
        }
      }
    };
  }
