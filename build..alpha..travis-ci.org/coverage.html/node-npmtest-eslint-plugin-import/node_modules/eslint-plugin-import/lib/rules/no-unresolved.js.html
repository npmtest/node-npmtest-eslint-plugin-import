...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/no-unresolved.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/no-unresolved.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/</a> &#187; no-unresolved.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >    function checkSourceValue(source) {</span>
<span class="cstat-no" title="statement not covered" >      const shouldCheckCase = !_resolve.CASE_SENSITIVE_FS &amp;&amp; (!context.options[0] || context.options[0].caseSensitive !== false);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      const resolvedPath = (0, _resolve2.default)(source.value, context);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (resolvedPath === undefined) {</span>
<span class="cstat-no" title="statement not covered" >        context.report(source, `Unable to resolve path to module '${ source.value }'.`);</span>
      } else <span class="cstat-no" title="statement not covered" >if (shouldCheckCase) {</span>
<span class="cstat-no" title="statement not covered" >        const cacheSettings = _ModuleCache2.default.getSettings(context.settings);</span>
<span class="cstat-no" title="statement not covered" >        if (!(0, _resolve.fileExistsWithCaseSync)(resolvedPath, cacheSettings)) {</span>
<span class="cstat-no" title="statement not covered" >          context.report(source, `Casing of ${ source.value } does not match the underlying filesystem.`);</span>
        }
      }
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return (0, _moduleVisitor2.default)(checkSourceValue, context.options[0]);</span>
  }
}; /**
