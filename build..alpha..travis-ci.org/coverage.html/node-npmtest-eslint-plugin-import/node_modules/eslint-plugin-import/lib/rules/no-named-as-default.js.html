...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/no-named-as-default.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/no-named-as-default.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/</a> &#187; no-named-as-default.js</div>
</div>
<div class="body">
...
<span class="fstat-no" title="function not covered" >    function checkDefault(nameKey, defaultSpecifier) {</span>
      // #566: default is a valid specifier
<span class="cstat-no" title="statement not covered" >      if (defaultSpecifier[nameKey].name === 'default') <span class="cstat-no" title="statement not covered" >return;</span></span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (imports.has('default') &amp;&amp; imports.has(defaultSpecifier[nameKey].name)) {</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        context.report(defaultSpecifier, 'Using exported name \'' + defaultSpecifier[nameKey].name + '\' as identifier for default export.');</span>
      }
    }
<span class="cstat-no" title="statement not covered" >    return {</span>
