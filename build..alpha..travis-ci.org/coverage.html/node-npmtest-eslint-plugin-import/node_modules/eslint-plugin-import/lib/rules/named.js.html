...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/named.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/named.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/</a> &#187; named.js</div>
</div>
<div class="body">
...
<span class="fstat-no" title="function not covered" >    function checkSpecifiers(key, type, node) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (!node.specifiers.some(<span class="fstat-no" title="function not covered" >function (im) {</span></span>
<span class="cstat-no" title="statement not covered" >        return im.type === type;</span>
      })) {
<span class="cstat-no" title="statement not covered" >        return; </span>// no named imports/exports
      }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        if (im.type !== type) <span class="cstat-no" title="statement not covered" >return;</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        const deepLookup = imports.hasDeep(im[key].name);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!deepLookup.found) {</span>
<span class="cstat-no" title="statement not covered" >          if (deepLookup.path.length &gt; 1) {</span>
<span class="cstat-no" title="statement not covered" >            const deepPath = deepLookup.path.map(i =&gt; <span class="cstat-no" title="statement not covered" >path.relative(path.dirname(context.getFilename()), i.path))</span>.join(' -&gt; ');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            context.report(im[key], `${ im[key].name } not found via ${ deepPath }`);</span>
          } else {
<span class="cstat-no" title="statement not covered" >            context.report(im[key], im[key].name + ' not found in \'' + node.source.value + '\'');</span>
          }
        }
      });
    }
