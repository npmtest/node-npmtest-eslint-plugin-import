...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/no-duplicates.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/no-duplicates.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/</a> &#187; no-duplicates.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >function checkImports(imported, context) {</span>
<span class="cstat-no" title="statement not covered" >  for (let _ref of imported.entries()) {</span>
<span class="cstat-no" title="statement not covered" >    var _ref2 = _slicedToArray(_ref, 2);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    let module = _ref2[0];</span>
<span class="cstat-no" title="statement not covered" >    let nodes = _ref2[1];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (nodes.size &gt; 1) {</span>
<span class="cstat-no" title="statement not covered" >      for (let node of nodes) {</span>
<span class="cstat-no" title="statement not covered" >        context.report(node, `'${ module }' imported multiple times.`);</span>
      }
    }
  }
}
...
<span class="cstat-no" title="statement not covered" >    const imported = new Map();</span>
<span class="cstat-no" title="statement not covered" >    const typesImported = new Map();</span>
<span class="cstat-no" title="statement not covered" >    return {</span>
      'ImportDeclaration': <span class="fstat-no" title="function not covered" >function (n) {</span>
        // resolved path will cover aliased duplicates
<span class="cstat-no" title="statement not covered" >        const resolvedPath = (0, _resolve2.default)(n.source.value, context) || n.source.value;</span>
<span class="cstat-no" title="statement not covered" >        const importMap = n.importKind === 'type' ? typesImported : imported;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (importMap.has(resolvedPath)) {</span>
<span class="cstat-no" title="statement not covered" >          importMap.get(resolvedPath).add(n.source);</span>
        } else {
<span class="cstat-no" title="statement not covered" >          importMap.set(resolvedPath, new Set([n.source]));</span>
        }
      },
&nbsp;
      'Program:exit': <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >        checkImports(imported, context);</span>
<span class="cstat-no" title="statement not covered" >        checkImports(typesImported, context);</span>
      }
    };
  }
};
