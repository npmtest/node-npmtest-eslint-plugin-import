...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/no-amd.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/no-amd.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/</a> &#187; no-amd.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="cstat-no" title="statement not covered" >                if (node.callee.type !== 'Identifier') <span class="cstat-no" title="statement not covered" >return;</span></span>
<span class="cstat-no" title="statement not covered" >                if (node.callee.name !== 'require' &amp;&amp; node.callee.name !== 'define') <span class="cstat-no" title="statement not covered" >return;</span></span>
&nbsp;
                // todo: capture define((require, module, exports) =&gt; {}) form?
<span class="cstat-no" title="statement not covered" >                if (node.arguments.length !== 2) <span class="cstat-no" title="statement not covered" >return;</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                const modules = node.arguments[0];</span>
<span class="cstat-no" title="statement not covered" >                if (modules.type !== 'ArrayExpression') <span class="cstat-no" title="statement not covered" >return;</span></span>
&nbsp;
                // todo: check second arg type? (identifier or callback)
&nbsp;
<span class="cstat-no" title="statement not covered" >                context.report(node, `Expected imports instead of AMD ${ node.callee.name }().`);</span>
            }
        };
    }
};
