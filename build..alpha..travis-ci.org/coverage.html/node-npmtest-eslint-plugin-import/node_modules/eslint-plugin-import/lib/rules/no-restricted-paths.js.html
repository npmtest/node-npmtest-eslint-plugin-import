...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/no-restricted-paths.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/no-restricted-paths.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/</a> &#187; no-restricted-paths.js</div>
</div>
<div class="body">
...
&nbsp;
  create: <span class="fstat-no" title="function not covered" >function noRestrictedPaths(context) {</span>
<span class="cstat-no" title="statement not covered" >    const options = context.options[0] || {};</span>
<span class="cstat-no" title="statement not covered" >    const restrictedPaths = options.zones || [];</span>
<span class="cstat-no" title="statement not covered" >    const basePath = options.basePath || process.cwd();</span>
<span class="cstat-no" title="statement not covered" >    const currentFilename = context.getFilename();</span>
<span class="cstat-no" title="statement not covered" >    const matchingZones = restrictedPaths.filter(zone =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      const targetPath = _path2.default.resolve(basePath, zone.target);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      return (0, _containsPath2.default)(currentFilename, targetPath);</span>
    });
&nbsp;
<span class="fstat-no" title="function not covered" >    function checkForRestrictedImportPath(importPath, node) {</span>
<span class="cstat-no" title="statement not covered" >      const absoluteImportPath = (0, _resolve2.default)(importPath, context);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (!absoluteImportPath) {</span>
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      matchingZones.forEach(zone =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        const absoluteFrom = _path2.default.resolve(basePath, zone.from);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if ((0, _containsPath2.default)(absoluteImportPath, absoluteFrom)) {</span>
...
<span class="cstat-no" title="statement not covered" >        checkForRestrictedImportPath(node.source.value, node.source);</span>
      },
...
&nbsp;
&nbsp;
<span class="cstat-no" title="statement not covered" >          checkForRestrictedImportPath(firstArgument.value, firstArgument);</span>
        }
      }
    };
  }
