...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/core/importType.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/core/importType.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/core/</a> &#187; importType.js</div>
</div>
<div class="body">
...
function constant(value) {
  return () =&gt; <span class="cstat-no" title="statement not covered" >value;</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function isAbsolute(name) {</span>
<span class="cstat-no" title="statement not covered" >  return name.indexOf('/') === 0;</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function isBuiltIn(name, settings) {</span>
<span class="cstat-no" title="statement not covered" >  const extras = settings &amp;&amp; settings['import/core-modules'] || [];</span>
<span class="cstat-no" title="statement not covered" >  return _builtinModules2.default.indexOf(name) !== -1 || extras.indexOf(name) &gt; -1;</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function isExternalPath(path, name, settings) {</span>
<span class="cstat-no" title="statement not covered" >  const folders = settings &amp;&amp; settings['import/external-module-folders'] || ['node_modules'];</span>
<span class="cstat-no" title="statement not covered" >  return !path || folders.some(folder =&gt; <span class="cstat-no" title="statement not covered" >-1 &lt; path.indexOf((0, _path.join)(folder, name)))</span>;</span>
}
&nbsp;
const externalModuleRegExp = /^\w/;
<span class="fstat-no" title="function not covered" >function isExternalModule(name, settings, path) {</span>
<span class="cstat-no" title="statement not covered" >  return externalModuleRegExp.test(name) &amp;&amp; isExternalPath(path, name, settings);</span>
}
&nbsp;
const scopedRegExp = /^@\w+\/\w+/;
<span class="fstat-no" title="function not covered" >function isScoped(name) {</span>
<span class="cstat-no" title="statement not covered" >  return scopedRegExp.test(name);</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function isInternalModule(name, settings, path) {</span>
<span class="cstat-no" title="statement not covered" >  return externalModuleRegExp.test(name) &amp;&amp; !isExternalPath(path, name, settings);</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function isRelativeToParent(name) {</span>
<span class="cstat-no" title="statement not covered" >  return name.indexOf('../') === 0;</span>
}
&nbsp;
const indexFiles = ['.', './', './index', './index.js'];
<span class="fstat-no" title="function not covered" >function isIndex(name) {</span>
<span class="cstat-no" title="statement not covered" >  return indexFiles.indexOf(name) !== -1;</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function isRelativeToSibling(name) {</span>
<span class="cstat-no" title="statement not covered" >  return name.indexOf('./') === 0;</span>
}
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >function resolveImportType(name, context) {</span>
<span class="cstat-no" title="statement not covered" >  return typeTest(name, context.settings, (0, _resolve2.default)(name, context));</span>
}
