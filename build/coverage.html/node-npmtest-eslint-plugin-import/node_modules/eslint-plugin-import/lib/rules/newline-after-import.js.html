...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/newline-after-import.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/newline-after-import.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/</a> &#187; newline-after-import.js</div>
</div>
<div class="body">
...
//------------------------------------------------------------------------------
&nbsp;
<span class="fstat-no" title="function not covered" >function containsNodeOrEqual(outerNode, innerNode) {</span>
<span class="cstat-no" title="statement not covered" >  return outerNode.range[0] &lt;= innerNode.range[0] &amp;&amp; outerNode.range[1] &gt;= innerNode.range[1];</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function getScopeBody(scope) {</span>
<span class="cstat-no" title="statement not covered" >  if (scope.block.type === 'SwitchStatement') {</span>
<span class="cstat-no" title="statement not covered" >    log('SwitchStatement scopes not supported');</span>
<span class="cstat-no" title="statement not covered" >    return null;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  const body = scope.block.body;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (body &amp;&amp; body.type === 'BlockStatement') {</span>
<span class="cstat-no" title="statement not covered" >    return body.body;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return body;</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function findNodeIndexInScopeBody(body, nodeToFind) {</span>
<span class="cstat-no" title="statement not covered" >  return body.findIndex(node =&gt; <span class="cstat-no" title="statement not covered" >containsNodeOrEqual(node, nodeToFind))</span>;</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function getLineDifference(node, nextNode) {</span>
<span class="cstat-no" title="statement not covered" >  return nextNode.loc.start.line - node.loc.end.line;</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function isClassWithDecorator(node) {</span>
<span class="cstat-no" title="statement not covered" >  return node.type === 'ClassDeclaration' &amp;&amp; node.decorators &amp;&amp; node.decorators.length;</span>
}
&nbsp;
module.exports = {
  meta: {
...
<span class="cstat-no" title="statement not covered" >    const requireCalls = [];</span>
&nbsp;
<span class="fstat-no" title="function not covered" >    function checkForNewLine(node, nextNode, type) {</span>
<span class="cstat-no" title="statement not covered" >      if (isClassWithDecorator(nextNode)) {</span>
<span class="cstat-no" title="statement not covered" >        nextNode = nextNode.decorators[0];</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (getLineDifference(node, nextNode) &lt; 2) {</span>
<span class="cstat-no" title="statement not covered" >        let column = node.loc.start.column;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (node.loc.start.line !== node.loc.end.line) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        const nodePosition = parent.body.indexOf(node);</span>
<span class="cstat-no" title="statement not covered" >        const nextNode = parent.body[nodePosition + 1];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (nextNode &amp;&amp; nextNode.type !== 'ImportDeclaration') {</span>
<span class="cstat-no" title="statement not covered" >          checkForNewLine(node, nextNode, 'import');</span>
        }
      },
      CallExpression: <span class="fstat-no" title="function not covered" >function (node) {</span>
<span class="cstat-no" title="statement not covered" >        if ((0, _staticRequire2.default)(node) &amp;&amp; level === 0) {</span>
<span class="cstat-no" title="statement not covered" >          requireCalls.push(node);</span>
        }
      },
      'Program:exit': <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >        log('exit processing for', context.getFilename());</span>
<span class="cstat-no" title="statement not covered" >        const scopeBody = getScopeBody(context.getScope());</span>
<span class="cstat-no" title="statement not covered" >        log('got scope:', scopeBody);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        requireCalls.forEach(<span class="fstat-no" title="function not covered" >function (node, index) {</span></span>
<span class="cstat-no" title="statement not covered" >          const nodePosition = findNodeIndexInScopeBody(scopeBody, node);</span>
<span class="cstat-no" title="statement not covered" >          log('node position in scope:', nodePosition);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          const statementWithRequireCall = scopeBody[nodePosition];</span>
<span class="cstat-no" title="statement not covered" >          const nextStatement = scopeBody[nodePosition + 1];</span>
<span class="cstat-no" title="statement not covered" >          const nextRequireCall = requireCalls[index + 1];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (nextRequireCall &amp;&amp; containsNodeOrEqual(statementWithRequireCall, nextRequireCall)) {</span>
<span class="cstat-no" title="statement not covered" >            return;</span>
          }
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (nextStatement &amp;&amp; (!nextRequireCall || !containsNodeOrEqual(nextStatement, nextRequireCall))) {</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            checkForNewLine(statementWithRequireCall, nextStatement, 'require');</span>
          }
        });
      },
