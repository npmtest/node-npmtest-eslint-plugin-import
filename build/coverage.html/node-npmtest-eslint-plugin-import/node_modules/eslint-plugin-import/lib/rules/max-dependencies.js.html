...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/max-dependencies.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/max-dependencies.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/</a> &#187; max-dependencies.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >  var _ref = context.options[0] || { max: DEFAULT_MAX };</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  const max = _ref.max;</span>
&nbsp;
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (dependencies.size &gt; max) {</span>
<span class="cstat-no" title="statement not covered" >    context.report(lastNode, `Maximum number of dependencies (${ max }) exceeded.`);</span>
  }
};
&nbsp;
module.exports = {
...
&nbsp;
  create: context =&gt; {
<span class="cstat-no" title="statement not covered" >    const dependencies = new Set(); </span>// keep track of dependencies
<span class="cstat-no" title="statement not covered" >    let lastNode; </span>// keep track of the last node to report on
&nbsp;
<span class="cstat-no" title="statement not covered" >    return {</span>
      ImportDeclaration<span class="fstat-no" title="function not covered" >(node) {</span>
<span class="cstat-no" title="statement not covered" >        dependencies.add(node.source.value);</span>
<span class="cstat-no" title="statement not covered" >        lastNode = node.source;</span>
      },
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >          const requirePath = _node$arguments[0];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          dependencies.add(requirePath.value);</span>
...
<span class="cstat-no" title="statement not covered" >        countDependencies(dependencies, lastNode, context);</span>
      }
    };
  }
};
