...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/default.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/default.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/</a> &#187; default.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >    function checkDefault(specifierType, node) {</span>
&nbsp;
      // poor man's Array.find
<span class="cstat-no" title="statement not covered" >      let defaultSpecifier;</span>
<span class="cstat-no" title="statement not covered" >      node.specifiers.some(n =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        if (n.type === specifierType) {</span>
<span class="cstat-no" title="statement not covered" >          defaultSpecifier = n;</span>
<span class="cstat-no" title="statement not covered" >          return true;</span>
        }
      });
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (!defaultSpecifier) <span class="cstat-no" title="statement not covered" >return;</span></span>
<span class="cstat-no" title="statement not covered" >      var imports = _ExportMap2.default.get(node.source.value, context);</span>
...
<span class="cstat-no" title="statement not covered" >        imports.reportErrors(context, node);</span>
      } else <span class="cstat-no" title="statement not covered" >if (imports.get('default') === undefined) {</span>
<span class="cstat-no" title="statement not covered" >        context.report(defaultSpecifier, 'No default export found in module.');</span>
      }
    }
&nbsp;
