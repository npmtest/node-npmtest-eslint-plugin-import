...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/unambiguous.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/unambiguous.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/</a> &#187; unambiguous.js</div>
</div>
<div class="body">
...
&nbsp;
  create: <span class="fstat-no" title="function not covered" >function (context) {</span>
    // ignore non-modules
<span class="cstat-no" title="statement not covered" >    if (context.parserOptions.sourceType !== 'module') {</span>
<span class="cstat-no" title="statement not covered" >      return {};</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return {</span>
      Program: <span class="fstat-no" title="function not covered" >function (ast) {</span>
<span class="cstat-no" title="statement not covered" >        if (!(0, _unambiguous.isModule)(ast)) {</span>
