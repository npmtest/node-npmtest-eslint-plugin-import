...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/export.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/export.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/</a> &#187; export.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >    const named = new Map();</span>
&nbsp;
<span class="fstat-no" title="function not covered" >    function addNamed(name, node) {</span>
<span class="cstat-no" title="statement not covered" >      let nodes = named.get(name);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (nodes == null) {</span>
<span class="cstat-no" title="statement not covered" >        nodes = new Set();</span>
<span class="cstat-no" title="statement not covered" >        named.set(name, nodes);</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      nodes.add(node);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return {</span>
      'ExportDefaultDeclaration': node =&gt; <span class="cstat-no" title="statement not covered" >addNamed('default', node),</span>
&nbsp;
      'ExportSpecifier': <span class="fstat-no" title="function not covered" >function (node) {</span>
<span class="cstat-no" title="statement not covered" >        addNamed(node.exported.name, node.exported);</span>
      },
&nbsp;
      'ExportNamedDeclaration': <span class="fstat-no" title="function not covered" >function (node) {</span>
<span class="cstat-no" title="statement not covered" >        if (node.declaration == null) <span class="cstat-no" title="statement not covered" >return;</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (node.declaration.id != null) {</span>
<span class="cstat-no" title="statement not covered" >          addNamed(node.declaration.id.name, node.declaration.id);</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (node.declaration.declarations != null) {</span>
<span class="cstat-no" title="statement not covered" >          for (let declaration of node.declaration.declarations) {</span>
<span class="cstat-no" title="statement not covered" >            (0, _ExportMap.recursivePatternCapture)(declaration.id, v =&gt; <span class="cstat-no" title="statement not covered" >addNamed(v.name, v))</span>;</span>
          }
        }
      },
&nbsp;
      'ExportAllDeclaration': <span class="fstat-no" title="function not covered" >function (node) {</span>
<span class="cstat-no" title="statement not covered" >        if (node.source == null) <span class="cstat-no" title="statement not covered" >return; </span></span>// not sure if this is ever true
&nbsp;
<span class="cstat-no" title="statement not covered" >        const remoteExports = _ExportMap2.default.get(node.source.value, context);</span>
<span class="cstat-no" title="statement not covered" >        if (remoteExports == null) <span class="cstat-no" title="statement not covered" >return;</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (remoteExports.errors.length) {</span>
<span class="cstat-no" title="statement not covered" >          remoteExports.reportErrors(context, node);</span>
<span class="cstat-no" title="statement not covered" >          return;</span>
        }
<span class="cstat-no" title="statement not covered" >        let any = false;</span>
<span class="cstat-no" title="statement not covered" >        remoteExports.forEach((v, name) =&gt; <span class="cstat-no" title="statement not covered" >name !== 'default' &amp;&amp; (any = true) &amp;&amp; // poor man's filter</span></span>
        addNamed(name, node));
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!any) {</span>
<span class="cstat-no" title="statement not covered" >          context.report(node.source, `No named exports found in module '${ node.source.value }'.`);</span>
        }
      },
&nbsp;
      'Program:exit': <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >        for (let _ref of named) {</span>
<span class="cstat-no" title="statement not covered" >          var _ref2 = _slicedToArray(_ref, 2);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          let name = _ref2[0];</span>
<span class="cstat-no" title="statement not covered" >          let nodes = _ref2[1];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (nodes.size &lt;= 1) <span class="cstat-no" title="statement not covered" >continue;</span></span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >              context.report(node, 'Multiple default exports.');</span>
            } else <span class="cstat-no" title="statement not covered" >context.report(node, `Multiple exports of name '${ name }'.`);</span>
          }
        }
      }
    };
