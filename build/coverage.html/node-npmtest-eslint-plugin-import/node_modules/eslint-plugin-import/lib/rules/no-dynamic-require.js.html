...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/no-dynamic-require.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/no-dynamic-require.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/</a> &#187; no-dynamic-require.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >  return node &amp;&amp; node.callee &amp;&amp; node.callee.type === 'Identifier' &amp;&amp; node.callee.name === 'require' &amp;&amp; node.arguments.length &gt;= 1;</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function isStaticValue(arg) {</span>
<span class="cstat-no" title="statement not covered" >  return arg.type === 'Literal' || arg.type === 'TemplateLiteral' &amp;&amp; arg.expressions.length === 0;</span>
}
&nbsp;
module.exports = {
  meta: {
...
<span class="cstat-no" title="statement not covered" >        if (isRequire(node) &amp;&amp; !isStaticValue(node.arguments[0])) {</span>
