...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/no-mutable-exports.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/no-mutable-exports.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/</a> &#187; no-mutable-exports.js</div>
</div>
<div class="body">
...
<span class="fstat-no" title="function not covered" >    function checkDeclaration(node) {</span>
<span class="cstat-no" title="statement not covered" >      const kind = node.kind;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (kind === 'var' || kind === 'let') {</span>
<span class="cstat-no" title="statement not covered" >        context.report(node, `Exporting mutable '${ kind }' binding, use 'const' instead.`);</span>
      }
    }
&nbsp;
<span class="fstat-no" title="function not covered" >    function checkDeclarationsInScope(_ref, name) {</span>
<span class="cstat-no" title="statement not covered" >      let variables = _ref.variables;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      for (let variable of variables) {</span>
<span class="cstat-no" title="statement not covered" >        if (variable.name === name) {</span>
<span class="cstat-no" title="statement not covered" >          for (let def of variable.defs) {</span>
<span class="cstat-no" title="statement not covered" >            if (def.type === 'Variable') {</span>
<span class="cstat-no" title="statement not covered" >              checkDeclaration(def.parent);</span>
            }
          }
        }
      }
...
&nbsp;
<span class="fstat-no" title="function not covered" >    function handleExportDefault(node) {</span>
<span class="cstat-no" title="statement not covered" >      const scope = context.getScope();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (node.declaration.name) {</span>
<span class="cstat-no" title="statement not covered" >        checkDeclarationsInScope(scope, node.declaration.name);</span>
      }
    }
&nbsp;
<span class="fstat-no" title="function not covered" >    function handleExportNamed(node) {</span>
<span class="cstat-no" title="statement not covered" >      const scope = context.getScope();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (node.declaration) {</span>
<span class="cstat-no" title="statement not covered" >        checkDeclaration(node.declaration);</span>
      } else <span class="cstat-no" title="statement not covered" >if (!node.source) {</span>
<span class="cstat-no" title="statement not covered" >        for (let specifier of node.specifiers) {</span>
<span class="cstat-no" title="statement not covered" >          checkDeclarationsInScope(scope, specifier.local.name);</span>
        }
      }
    }
&nbsp;
