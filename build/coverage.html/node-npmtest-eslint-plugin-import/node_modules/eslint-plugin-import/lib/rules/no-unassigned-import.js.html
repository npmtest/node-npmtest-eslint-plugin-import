...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/no-unassigned-import.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/no-unassigned-import.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/</a> &#187; no-unassigned-import.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >      if (node.expression.type === 'CallExpression' &amp;&amp; (0, _staticRequire2.default)(node.expression)) {</span>
<span class="cstat-no" title="statement not covered" >        report(context, node.expression);</span>
      }
    }
  };
}
