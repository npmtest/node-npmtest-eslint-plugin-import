...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/extensions.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/extensions.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/</a> &#187; extensions.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >    const configuration = context.options[0] || 'never';</span>
<span class="cstat-no" title="statement not covered" >    const defaultConfig = typeof configuration === 'string' ? configuration : null;</span>
<span class="cstat-no" title="statement not covered" >    const modifiers = Object.assign({}, typeof configuration === 'object' ? configuration : context.options[1]);</span>
&nbsp;
<span class="fstat-no" title="function not covered" >    function isUseOfExtensionRequired(extension) {</span>
<span class="cstat-no" title="statement not covered" >      if (!(0, _has2.default)(modifiers, extension)) {</span>
<span class="cstat-no" title="statement not covered" >        modifiers[extension] = defaultConfig;</span>
      }
<span class="cstat-no" title="statement not covered" >      return modifiers[extension] === 'always';</span>
    }
&nbsp;
<span class="fstat-no" title="function not covered" >    function isUseOfExtensionForbidden(extension) {</span>
<span class="cstat-no" title="statement not covered" >      if (!(0, _has2.default)(modifiers, extension)) {</span>
<span class="cstat-no" title="statement not covered" >        modifiers[extension] = defaultConfig;</span>
      }
<span class="cstat-no" title="statement not covered" >      return modifiers[extension] === 'never';</span>
    }
&nbsp;
<span class="fstat-no" title="function not covered" >    function isResolvableWithoutExtension(file) {</span>
<span class="cstat-no" title="statement not covered" >      const extension = _path2.default.extname(file);</span>
<span class="cstat-no" title="statement not covered" >      const fileWithoutExtension = file.slice(0, -extension.length);</span>
<span class="cstat-no" title="statement not covered" >      const resolvedFileWithoutExtension = (0, _resolve2.default)(fileWithoutExtension, context);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      return resolvedFileWithoutExtension === (0, _resolve2.default)(file, context);</span>
    }
&nbsp;
<span class="fstat-no" title="function not covered" >    function checkFileExtension(node) {</span>
<span class="cstat-no" title="statement not covered" >      const source = node.source;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      const importPath = source.value;</span>
&nbsp;
      // don't enforce anything on builtins
<span class="cstat-no" title="statement not covered" >      if ((0, _importType.isBuiltIn)(importPath, context.settings)) <span class="cstat-no" title="statement not covered" >return;</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      const resolvedPath = (0, _resolve2.default)(importPath, context);</span>
&nbsp;
      // get extension from resolved path, if possible.
      // for unresolved, use source value.
<span class="cstat-no" title="statement not covered" >      const extension = _path2.default.extname(resolvedPath || importPath).substring(1);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (!extension || !importPath.endsWith(extension)) {</span>
<span class="cstat-no" title="statement not covered" >        if (isUseOfExtensionRequired(extension) &amp;&amp; !isUseOfExtensionForbidden(extension)) {</span>
...
<span class="cstat-no" title="statement not covered" >        if (isUseOfExtensionForbidden(extension) &amp;&amp; isResolvableWithoutExtension(importPath)) {</span>
<span class="cstat-no" title="statement not covered" >          context.report({</span>
            node: source,
