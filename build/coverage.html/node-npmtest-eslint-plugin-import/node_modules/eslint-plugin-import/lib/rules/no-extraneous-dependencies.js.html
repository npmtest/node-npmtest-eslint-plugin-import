...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/no-extraneous-dependencies.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/no-extraneous-dependencies.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-eslint-plugin-import/node_modules/eslint-plugin-import/lib/rules/</a> &#187; no-extraneous-dependencies.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >function getDependencies(context) {</span>
<span class="cstat-no" title="statement not covered" >  const filepath = _pkgUp2.default.sync(context.getFilename());</span>
<span class="cstat-no" title="statement not covered" >  if (!filepath) {</span>
<span class="cstat-no" title="statement not covered" >    return null;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  try {</span>
<span class="cstat-no" title="statement not covered" >    const packageContent = JSON.parse(_fs2.default.readFileSync(filepath, 'utf8'));</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >function missingErrorMessage(packageName) {</span>
<span class="cstat-no" title="statement not covered" >  return `'${ packageName }' should be listed in the project's dependencies. ` + `Run 'npm i -S ${ packageName }' to add it`;</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function devDepErrorMessage(packageName) {</span>
<span class="cstat-no" title="statement not covered" >  return `'${ packageName }' should be listed in the project's dependencies, not devDependencies.`;</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function optDepErrorMessage(packageName) {</span>
<span class="cstat-no" title="statement not covered" >  return `'${ packageName }' should be listed in the project's dependencies, ` + `not optionalDependencies.`;</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function reportIfMissing(context, deps, depsOptions, node, name) {</span>
<span class="cstat-no" title="statement not covered" >  if ((0, _importType2.default)(name, context) !== 'external') {</span>
<span class="cstat-no" title="statement not covered" >    return;</span>
  }
<span class="cstat-no" title="statement not covered" >  const splitName = name.split('/');</span>
<span class="cstat-no" title="statement not covered" >  const packageName = splitName[0][0] === '@' ? splitName.slice(0, 2).join('/') : splitName[0];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  const isInDeps = deps.dependencies[packageName] !== undefined;</span>
<span class="cstat-no" title="statement not covered" >  const isInDevDeps = deps.devDependencies[packageName] !== undefined;</span>
<span class="cstat-no" title="statement not covered" >  const isInOptDeps = deps.optionalDependencies[packageName] !== undefined;</span>
<span class="cstat-no" title="statement not covered" >  const isInPeerDeps = deps.peerDependencies[packageName] !== undefined;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (isInDeps || depsOptions.allowDevDeps &amp;&amp; isInDevDeps || depsOptions.allowPeerDeps &amp;&amp; isInPeerDeps || depsOptions.allowOptDeps &amp;&amp; isInOptDeps) {</span>
<span class="cstat-no" title="statement not covered" >    return;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (isInDevDeps &amp;&amp; !depsOptions.allowDevDeps) {</span>
<span class="cstat-no" title="statement not covered" >    context.report(node, devDepErrorMessage(packageName));</span>
<span class="cstat-no" title="statement not covered" >    return;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (isInOptDeps &amp;&amp; !depsOptions.allowOptDeps) {</span>
<span class="cstat-no" title="statement not covered" >    context.report(node, optDepErrorMessage(packageName));</span>
<span class="cstat-no" title="statement not covered" >    return;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  context.report(node, missingErrorMessage(packageName));</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function testConfig(config, filename) {</span>
  // Simplest configuration first, either a boolean or nothing.
<span class="cstat-no" title="statement not covered" >  if (typeof config === 'boolean' || typeof config === 'undefined') {</span>
<span class="cstat-no" title="statement not covered" >    return config;</span>
  }
  // Array of globs.
<span class="cstat-no" title="statement not covered" >  return config.some(c =&gt; <span class="cstat-no" title="statement not covered" >(0, _minimatch2.default)(filename, c) || (0, _minimatch2.default)(filename, _path2.default.join(process.cwd(), c)))</span>;</span>
}
&nbsp;
module.exports = {
  meta: {
...
<span class="cstat-no" title="statement not covered" >    const deps = getDependencies(context);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!deps) {</span>
<span class="cstat-no" title="statement not covered" >      return {};</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    const depsOptions = {</span>
...
<span class="cstat-no" title="statement not covered" >        reportIfMissing(context, deps, depsOptions, node, node.source.value);</span>
      },
...
<span class="cstat-no" title="statement not covered" >          reportIfMissing(context, deps, depsOptions, node, node.arguments[0].value);</span>
        }
      }
    };
  }
